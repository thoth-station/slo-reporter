...
"""This file contains class for Thoth Recommendations SLI."""
...
class SLIThothRecommendationsTypesInputs(SLIBase):
    """This class contain functions for Thoth Recommendations Types SLI."""

    _SLI_NAME = "adviser_recommendation_info"
    ...
    def _evaluate_sli(self) -> Dict[str, Any]:
        """Evaluate SLI for report for Thoth Recommendations Types SLI.
    ...
    def _report_sli(self, sli: Dict[str, Any]) -> str:
        """Create report for Thoth Recommendations Types SLI.

        @param sli: It's a dict of SLI associated with the SLI type.
        """
        html_inputs = self._evaluate_sli()
        report = HTMLTemplates.thoth_recommendations_template(html_inputs=html_inputs)
