...
class SLIWorkflowTaskLatency(SLIBase):
    """This class contains functions for Workflow Task Latency SLI (Thoth components)."""

    _SLI_NAME = "component_task_latency"
    ...
    def _evaluate_sli(self, sli: Dict[str, Any]) -> Dict[str, float]:
        ...
        for component in self.configuration.registered_workflow_tasks:
            ...
            for bucket in self.configuration.buckets:
                number_workflows_latency_seconds_bucket = sli[f"{component}_workflows_task_latency_bucket_{bucket}"]
    ...
    def _report_sli(self, sli: Dict[str, Any]) -> str:
        ...
        report = HTMLTemplates.thoth_workflows_task_latency_template(
